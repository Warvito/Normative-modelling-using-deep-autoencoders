...
def main():
    ...
    for i_repetition in range(n_repetitions):
        ...
        for i_fold, (train_index, test_index) in enumerate(kf.split(x_data)):
            ...
            test_dataset = tf.data.Dataset.from_tensor_slices((x_data_normalized_test, y_data_test))
